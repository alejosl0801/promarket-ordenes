...
> *(cuando el cliente abre con "quiero realizar mi pedido" — ya quiere comprar, NO preguntar para quién)*
...
### /sin_tienda_fisica
> *(cuando cliente dice "iré al local", "voy personalmente", "dónde está el local")*
> no tenemos local físico — trabajamos únicamente con envíos 😊
> Servientrega lo lleva a la agencia más cercana a usted y paga al retirar, sin anticipos ✅
> ¿le parece bien así?
...
> *(cuando el cliente pregunta por otros dispositivos de movimiento)*
> por el momento el guante es nuestro equipo especializado para manos — es lo más completo que tenemos para su caso 😊
> y precisamente el guante genera el movimiento, no solo lo acompaña — trabaja mediante presión de aire controlada electrónicamente 💪
> ¿se anima a probarlo? paga solo al retirar, si no le convence no lo retira ✅
...
### /par_guante
> llevando el par le hago un precio especial 😊
> dos unidades le salen en $107.98 con envío incluido
> ¿le proceso el par?

### /par_cuadriplejia
> *(upsell natural para cuadripléjico bilateral)*
> para trabajar ambas manos lo ideal es el par
> dos guantes le salen en $107.98 con envío incluido — paga al retirar ✅
> ¿le genero el pedido con el par?
...
> recuerde que el pago es al retirar — si al recibir no le convence, no lo retira. Cero riesgo ✅

### /precio_especial
> la verdad ya le estoy dando el mejor precio que tengo 😊
> con el envío incluido ya es un precio increíble — no me da para más sin autorización 😅
