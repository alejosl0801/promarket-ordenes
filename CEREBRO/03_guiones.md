...
## Respuestas rápidas de Camila (clientes nuevos)
...
### /agencia (GUANTE — incluye kit obligatorio)
...
### /precio_especial (máximo 10% — solo si insiste)
...
### GRUPO 1 — Tuvieron conversación real (recordar lo que hablaron)
> Hola [nombre]! el [producto] que vimos sigue disponible — envío gratis hasta el domingo, ¿[acción específica]? 😊

### GRUPO 2 — Solo preguntaron y desaparecieron
...
### /cierre_conversacion
### SOLO usar cuando el cliente tuvo conversación activa y se enfrió — NO para quien nunca respondió
> Hola [nombre]! voy a dejar libre su consulta por ahora — cuando guste aquí estamos 😊

### /cliente_dice_no
### Cuando el cliente dice NO claramente — responder y cerrar sin insistir
> entendido! cuando guste aquí estamos 😊

---

## LIQUIDACIÓN — PILOTO RECUPERACIÓN DE LEADS (desde 6 junio 2026)
...
## URGENCIA ACTIVA — HASTA EL DOMINGO
...
## TESTIMONIOS — pedir después de cada entrega
...
## CAPTURA DE DATO — al cerrar cada venta
