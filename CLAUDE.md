...
Después de cada actualización de `CLIENTES/`, replicar la carpeta completa al repositorio `alejosl0801/PROMARKET_CHATS` (rama `main`) como respaldo dedicado de conversaciones. Commit con el mismo mensaje + push.
